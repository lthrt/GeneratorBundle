...
use Lthrt\GeneratorBundle\Manipulator\KernelManipulator;
use Lthrt\GeneratorBundle\Tests\Generator\GeneratorTest;
...
class KernelManipulatorTest extends GeneratorTest
{
    ...
    public function testAddToArray($kernelOriginFilePath)
    {
        ...
        $arguments = [$phpExecutable, '-l', $fullpath];
    ...
    {
        $stubs = [
            'With empty bundles array'               => [__DIR__ . '/Stubs/EmptyBundlesKernelStub.php'],
            'With empty multiline bundles array'     => [__DIR__ . '/Stubs/EmptyBundlesMultilineKernelStub.php'],
            'With bundles array contains comma'      => [__DIR__ . '/Stubs/ContainsCommaKernelStub.php'],
            'With bundles added w/o trailing comma'  => [__DIR__ . '/Stubs/ContainsBundlesKernelStub.php'],
            'With some extra code and bad formatted' => [__DIR__ . '/Stubs/ContainsExtraCodeKernelStub.php'],
        ];

        if (PHP_VERSION_ID >= 50400) {
            $stubs = array_merge($stubs, [
                'With empty bundles array, short array syntax'              => [__DIR__ . '/Stubs/EmptyBundlesShortArraySyntaxKernelStub.php'],
                'With empty multiline bundles array, short array syntax'    => [__DIR__ . '/Stubs/EmptyBundlesMultilineShortArraySyntaxKernelStub.php'],
                'With bundles array contains comma, short array syntax'     => [__DIR__ . '/Stubs/ContainsCommaShortArraySyntaxKernelStub.php'],
                'With bundles added w/o trailing comma, short array syntax' => [__DIR__ . '/Stubs/ContainsBundlesShortArraySyntaxKernelStub.php'],
            ]);
        }
