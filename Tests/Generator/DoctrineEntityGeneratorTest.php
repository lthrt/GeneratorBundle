...
class DoctrineEntityGeneratorTest extends GeneratorTest
{
    ...
    public function testGenerateSubNamespacedYaml()
    {
        ...
        $this->assertFilesExists($files);
        $this->assertAttributesAndMethodsExists([], 'Sub/Foo');
    }
    ...
    {
        return [
            ['fieldName' => 'bar', 'type' => 'string', 'length' => 255],
            ['fieldName' => 'baz', 'type' => 'integer', 'length' => 11],
        ];
    }
    ...
    public function getConfiguration()
    {
        ...
        $config->expects($this->any())->method('getEntityNamespaces')->will($this->returnValue(['Foo\\BarBundle']));
