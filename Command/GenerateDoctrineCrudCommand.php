...
use Lthrt\GeneratorBundle\Command\AutoComplete\EntitiesAutoCompleter;
use Lthrt\GeneratorBundle\Command\Helper\QuestionHelper;
use Lthrt\GeneratorBundle\Generator\DoctrineCrudGenerator;
use Lthrt\GeneratorBundle\Generator\DoctrineFormGenerator;
...
class GenerateDoctrineCrudCommand extends GenerateDoctrineCommand
{
    ...
    {
        $this
            ->setName('lthrt:generate:crud')
            ->setAliases(['generate:lthrt:crud'])
...
EOT
    ...
    protected function interact(
        ...
        $question->setValidator(['Lthrt\GeneratorBundle\Command\Validators', 'validateEntityName']);
        ...
        $question->setValidator(['Lthrt\GeneratorBundle\Command\Validators', 'validateFormat']);
    ...
    protected function updateAnnotationRouting(
        BundleInterface $bundle,
                        $entity,
                        $prefix
    ) {
