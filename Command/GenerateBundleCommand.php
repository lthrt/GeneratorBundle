...
use Lthrt\GeneratorBundle\Generator\BundleGenerator;
use Lthrt\GeneratorBundle\Manipulator\ConfigurationManipulator;
...
EOT
    ...
    protected function interact(
        ...
        if ($askForBundleName) {
            ...
            $question->setValidator(
                ['Lthrt\GeneratorBundle\Command\Validators', 'validateBundleName']
            );
    ...
    protected function checkAutoloader(
        OutputInterface $output,
        Bundle          $bundle
    ) {
