...
namespace Lthrt\GeneratorBundle\Generator;
...
class DoctrineCrudGenerator extends Generator
{
    ...
    public function generate(
        ...
        $this->actions         = $needWriteActions ? ['delete', 'edit', 'new', 'index', 'show'] : ['index', 'show'];
    ...
    protected function generateControllerClass($forceOverwrite)
    {
        ...
        $this->renderFile('crud/controller.php.twig', $target, [
            ...
            'format'                 => $this->format,
            'prefix'                 => strtolower(str_replace('\\', '_', $this->bundle->getNamespace())),
            // BC with Symfony 2.7
    ...
    {
        $this->renderFile('crud/views/form.html.twig.twig', $dir . '/form.html.twig', [
            'bundle'              => $this->bundle->getName(),
            'entity'              => $this->entity,
            'entity_pluralized'   => $this->entityPluralized,
            'entity_singularized' => $this->entitySingularized,
     ...
     * @param string $dir The path to the folder that hosts templates in the bundle
     */
    protected function generateItemView($dir)
    {
        $this->renderFile('crud/views/item.html.twig.twig',
            $dir . '/' . $this->entitySingularized . '.html.twig',
            [
                'route_prefix'        => $this->routePrefix,
                'route_name_prefix'   => $this->routeNamePrefix,
                'identifier'          => $this->metadata->identifier[0],
